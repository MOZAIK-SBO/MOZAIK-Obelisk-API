    ...
    swagger({
      ...
      documentation: {
        info: {
          ...
          description:
            "Stateless overarching MOZAIK-Obelisk API for storing data in Obelisk, storing keys, requesting computations, etc.",
          license: {
        ...
        tags: [
          ...
          {
            name: "MPC Parties",
            description: "Query and register MPC parties.",
          },
          {
            name: "MPC Keys",
            description: "Retrieve MPC key shares from the key store.",
          },
          {
            name: "FHE Keys",
            description: "Manage FHE keys in the key store.",
          },
